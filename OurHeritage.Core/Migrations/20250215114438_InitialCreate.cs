        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverProfilePicture = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CulturalArticles", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderHandiCraft", x => new { x.OrderId, x.HandiCraftId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CulturalArticles_CategoryId",
                table: "CulturalArticles",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CulturalArticles_UserId",
                table: "CulturalArticles",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Favorites_HandiCraftId",
                table: "Favorites",
                column: "HandiCraftId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HandiCrafts_CategoryId",
                table: "HandiCrafts",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_HandiCrafts_UserId",
                table: "HandiCrafts",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Likes_CulturalArticleId",
                table: "Likes",
                column: "CulturalArticleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderHandiCraft_HandiCraftId",
