...
namespace OurHeritage.Core.Migrations
{
    ...
    [Migration("20250627193953_UpdateConversationModelToAddGroupPicture")]
    partial class UpdateConversationModelToAddGroupPicture
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OurHeritage.Core.Entities.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OurHeritage.Core.Entities.ConversationUser", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OurHeritage.Core.Entities.MessageRead", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OurHeritage.Core.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OurHeritage.Core.Entities.Repost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OurHeritage.Core.Entities.UserInteraction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserId", "CulturalArticleId", "Type");

                    b.ToTable("UserInteractions");
                });

            modelBuilder.Entity("OurHeritage.Core.Entities.UserPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OurHeritage.Core.Entities.ConversationUser", b =>
                {
                    b.HasOne("OurHeritage.Core.Entities.Conversation", "Conversation")
            ...
            modelBuilder.Entity("OurHeritage.Core.Entities.MessageRead", b =>
                {
                    b.HasOne("OurHeritage.Core.Entities.Message", "Message")
            ...
            modelBuilder.Entity("OurHeritage.Core.Entities.Notification", b =>
                {
                    b.HasOne("OurHeritage.Core.Entities.User", "Actor")
                        .WithMany()
                        .HasForeignKey("ActorId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();

                    b.HasOne("OurHeritage.Core.Entities.Comment", "Comment")
                        .WithMany()
                    ...
                    b.HasOne("OurHeritage.Core.Entities.User", "Recipient")
                        .WithMany()
            ...
            modelBuilder.Entity("OurHeritage.Core.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("OurHeritage.Core.Entities.Order", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
